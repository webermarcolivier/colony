...
QT += xml widgets
LIBS += -L/usr/lib -lblitz -lboost_system -lboost_filesystem -lgsl -lode -lstdc++ -L/usr/local/atlas/lib -lgfortran -latlas -lcblas -lf77blas -llapack #-lGLU -lglut
INCLUDEPATH += /usr/local/include/ode /usr/local/atlas/include
#QMAKE_CFLAGS+=-pg
#QMAKE_CXXFLAGS+=-pg
#QMAKE_LFLAGS+=-pg
